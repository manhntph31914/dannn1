...
<!-- Mirrored from webstrot.com/html/luxuryshop/06_Luxury_Gadgets/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2023 14:23:13 GMT -->
<head>
	<meta charset="utf-8">
	...
	<title>Nhóm 9 bán laptop</title>
		
	<link rel="shortcut icon" href="view/images/favicon.png">
    <link href="view/libraries/bootstrap/bootstrap.min.css" rel="stylesheet"/>
	<link rel="stylesheet" href="view/libraries/fuelux/jquery-ui.min.css">
    <linK href="view/libraries/owl-carousel/owl.carousel.css" rel="stylesheet"/> <!-- Core Owl Carousel CSS File  *	v1.3.3 -->
    <linK href="view/libraries/owl-carousel/owl.theme.css" rel="stylesheet"/> <!-- Core Owl Carousel CSS Theme  File  *	v1.3.3 -->
	<link href="view/libraries/fonts/font-awesome.min.css" rel="stylesheet"/>
	<link href="view/libraries/animate/animate.min.css" rel="stylesheet"/>
	<link href="view/libraries/flexslider/flexslider.css" rel="stylesheet" /> <!-- flexslider -->
	<link href="view/libraries/magnific-popup.css" rel="stylesheet"/> <!-- Light Box -->
    <link href="view/css/components.css" rel="stylesheet"/>
	<link href="view/css/style.css" rel="stylesheet"/>
    <link href="view/css/media.css" rel="stylesheet"/>
	<link id="color" href="view/css/color-schemes/default.css" rel="stylesheet"/>
		...
		<div class="top-header">
			...
			<div class="container">
				<ul class="top-social col-md-6 col-sm-4">
					<li><a title="Facebook" href="javascript:;"><i class="fa fa-facebook"></i></a></li>
					<li><a title="Twitter" href="javascript:;"><i class="fa fa-twitter"></i></a></li>
					<li><a title="Google" href="javascript:;"><i class="fa fa-google-plus"></i></a></li>
					<li><a title="Pinterest" href="javascript:;"><i class="fa fa-pinterest-p"></i></a></li>
				</ul>
				<?php
				...
				<div class="col-md-6 ow-right-padding col-sm-8">
					<ul class="top-menu">
						<li><a title="Register" href="#">Xin chào: <?=$name?></a></li>
						<li><a title="cap nhat" href="index.php?act=edit_taikhoan">Cập nhật tài khoản</a></li>
						<?php
							if($role==1){
						?>
						<li><a title="Login" href="admin/index.php">Đăng nhập admin</a></li>
						<?php
							}
						?>
						<li><a title="Register" href="index.php?act=thoat">Đăng xuất</a></li>
					</ul>
				</div>
				<?php
				}else{
				...
				<div class="col-md-6 ow-right-padding col-sm-8">
					<ul class="top-menu">
						<li><a title="Login" href="index.php?act=dangnhap">Đăng nhập</a></li>
						<li><a title="Register" href="index.php?act=dangky">Đăng ký</a></li>
					</ul>
				</div>
				<?php
				}
				...
				<div class="col-md-6 logo-block col-sm-6 col-xs-6">
					<a title="Logo" href="index.html">
						<svg viewBox="0 0 60.666 57.701">
						 ...
						 <a href="index.php">Luxury Shop</a>
					</a>
				</div>
					...
					<div class="col-md-4 col-sm-12 col-xs-12 cart-link ow-right-padding">
						<svg width="16px" height="15px" viewBox="0 0 533.334 533.335">
							<g>
								...
								<p class="dropdownbtn" href="index.php?act=listCart">Giỏ hàng</p>
						...
						<div class="cart-dropdown">
							...
							<div class="cart-button">
								<a title="Add to cart" href="index.php?act=listCart">Tới giỏ hàng</a>
								<a title="Checkout" href="index.php?act=order">Checkout</a>
								<a title="Đơn hàng của tôi" href="index.php?act=checkout">Đơn hàng của tôi</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<nav class="navbar navbar-default navbar-static-top">						
					<div class="navbar-header">
						<a href="index.html" class="logo"><img src="view/images/logo.png" alt="logo"></a>
					...
					<div class="navbar-collapse collapse" id="navbar">
						<ul class="nav navbar-nav">
							<li class="active"><a title="Home" href="index.php">Trang chủ</a></li>
							<li><a title="Blog" href="index.php?act=blog" >Blog</a></li>	
							<li><a title="About Us" href="index.php?act=about">Về chúng tôi</a></li>
							<li><a title="Contact us" href="index.php?act=contact">Liên hệ</a></li>									
						</ul>
					</div><!--/.nav-collapse -->
				</nav>
			</div><!-- container /- -->
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="view/images/slider/slide-1.jpg" alt="slide-1">
					<div class="container">
						<div class="slider-box">
							<h3>Vẻ đẹp &amp; Chất lượng</h3>
							<h2>Đa dạng mẫu mã</h2>
							<p>Trải nghiệm những sản phẩm laptop công nghệ hiện đại nhất. </p>
						</div>
					</div>
				</div>
				<div class="item">
					<img src="view/images/slider/slide-2.jpg" alt="slide-1">
					<div class="container">
						<div class="slider-box">
							<h3>Vẻ đẹp &amp; Chất lượng</h3>
							<h2>Đa dạng mẫu mã</h2>
				...
				<div class="item">
					<img src="view/images/slider/slide-3.jpg" alt="slide-2">
					<div class="container">
						<div class="slider-box">
							<h3>Vẻ đẹp &amp; Chất lượng</h3>
							<h2>Đa dạng mẫu mã</h2>
